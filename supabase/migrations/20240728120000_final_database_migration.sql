-- =========== Final App Features Migration (v2) ===========
...
-- 6. Create/Update RPC function to get conversations with unread counts
...
BEGIN
  ...
  SELECT
    uc.id,
    uc.conversation_created_at AS created_at, -- ALIAS BACK to match return type
