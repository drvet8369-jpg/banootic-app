...
const LipstickIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M8.5 10.5c0-1.7 1.3-3.1 3-3.2 0.3 0 0.7-0.1 1-0.3 0.7-0.4 1-1.2 1-2.1 0-0.4-0.1-0.8-0.4-1.1 -0.2-0.2-0.5-0.3-0.8-0.3 -0.2 0-0.5 0.1-0.7 0.2L12 4l-0.7-0.2c-0.2-0.1-0.5-0.2-0.7-0.2 -0.3 0-0.6 0.1-0.8 0.3 -0.3 0.3-0.4 0.7-0.4 1.1 0 0.9 0.3 1.7 1 2.1 0.3 0.2 0.7 0.3 1 0.3 1.7 0.1 3 1.5 3 3.2" />
    <path d="M6 10h12" />
  </svg>
);
