    ...
    <div className="py-12 md:py-20">
      <div className="text-center mb-12">
        ...
        <p className="mt-3 text-lg text-foreground">
          ارائه‌دهندگان خدمات برای <span className="font-semibold">{service.name}</span> در دسته‌ی <Link href={`/services/${category.slug}`} className="font-semibold hover:underline text-inherit">{category.name}</Link>
        </p>
      </div>
