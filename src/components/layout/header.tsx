      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center gap-4 mx-auto">
          ...
          {isClient ? (
            ...
            // Static skeleton with fixed dimensions to prevent layout shift and hydration errors
            <div className="flex items-center gap-4">
              <div className="hidden h-10 w-40 md:flex md:items-center md:gap-2">
                <div className="h-full w-1/2 bg-muted rounded-md animate-pulse"></div>
                <div className="h-full w-1/2 bg-muted rounded-md animate-pulse"></div>
              </div>
