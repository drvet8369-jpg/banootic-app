    ...
    if (!isClient) {
      ...
      return (
        <div className="hidden md:flex items-center gap-2">
            ...
            <div className="h-10 w-16 rounded-md bg-muted/50 animate-pulse"></div>
        </div>
      );
    }
      ...
      <nav className="flex-grow p-4 space-y-2">
        {isClient && isLoggedIn && user ? (
           <>
            ...
            <SheetClose asChild>
              <Link href="/inbox" className="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary hover:bg-muted relative">
          ...
          <>
            ...
            <SheetClose asChild>
              <Link href="/register" className="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary hover:bg-muted">
