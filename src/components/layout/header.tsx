        ...
        <div className="flex items-center gap-2">
            ...
            <nav className="hidden md:flex items-center gap-2 text-sm font-medium">
                ...
                <DropdownMenu>
                    ...
                    {user.account_type === 'provider' ? (
                       <>
                        <DropdownMenuItem asChild>
                         ...
                         <DropdownMenuItem asChild>
                            <Link href="/agreements" className="relative flex items-center justify-between w-full">
                                <div>
                                    <Handshake className="ml-2 h-4 w-4 inline-block" />
                                    <span>توافق‌ها</span>
                                </div>
                                <AgreementBadge />
                            </Link>
                    ...
                    <DropdownMenuItem asChild>
                        <Link href="/inbox" className="relative flex items-center justify-between w-full">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-2 h-4 w-4 inline-block"><path d="M22 12h-6l-2 3h-4l-2-3H2"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/></svg>
                                <span>صندوق ورودی</span>
                            </div>
                           <InboxBadge />
                        </Link>
