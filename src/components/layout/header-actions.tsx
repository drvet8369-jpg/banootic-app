...
// This component contains all client-side logic and is loaded dynamically
// in Header.tsx to prevent hydration mismatches.
export default function HeaderActions() {
  ...
  useEffect(() => {
    ...
    checkUnread();
    // Using an interval is a simple way to keep the count updated.
    // For a production app, a more robust solution like WebSockets or SSE would be better.
