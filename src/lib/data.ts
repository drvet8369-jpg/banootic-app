...
export const providers: Provider[] = [
  // Beauty
  { id: 1, name: 'سالن زیبایی سارا', service: 'خدمات ناخن', location: 'ارومیه، خیابان والفجر', phone: '09121112233', bio: 'متخصص در طراحی و هنر ناخن مدرن.', categorySlug: 'beauty', serviceSlug: 'manicure-pedicure', rating: 4.8, reviewsCount: 45, portfolio: [{ src: 'https://placehold.co/400x250', aiHint: 'nail art' }, { src: 'https://placehold.co/400x250', aiHint: 'pedicure' }] },
