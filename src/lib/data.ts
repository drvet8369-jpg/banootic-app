...
const defaultProviders: Provider[] = [
  ...
  { id: 16, name: 'نان خانگی گندم', service: 'نان خانگی', location: 'ارومیه، مولوی', phone: '09000000016', bio: 'پخت روزانه انواع نان‌های حجیم، سنتی و رژیمی.', categorySlug: 'cooking', serviceSlug: 'homemade-bread', rating: 5.0, reviewsCount: 95, profileImage: { src: 'https://placehold.co/400x400.png', aiHint: 'baker woman' }, portfolio: [] },
  {
    ...
    name: 'مژگان جودکی',
    service: 'خدمات ناخن',
    location: 'ارومیه، شهرک بهداری',
    phone: '09000000017',
    bio: 'با جدیدترین متدهای روز دنیا، زیبایی را به دستان شما هدیه می‌دهم.',
    categorySlug: 'beauty',
    serviceSlug: 'manicure-pedicure',
    rating: 4.8,
    reviewsCount: 60,
    profileImage: { src: 'https://placehold.co/400x400.png', aiHint: 'nail art' },
    portfolio: []
  },
