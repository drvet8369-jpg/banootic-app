...
const defaultProviders: Provider[] = [
  { name: 'سالن زیبایی سارا', service: 'خدمات ناخن', location: 'ارومیه', phone: '09353847484', bio: 'متخصص در طراحی و هنر ناخن مدرن با سال‌ها تجربه در ارائه جدیدترین متدهای کاشت و ژلیش. ما به سلامت و زیبایی دستان شما اهمیت می‌دهیم.', categorySlug: 'beauty', serviceSlug: 'manicure-pedicure', rating: 4.8, reviewsCount: 45, agreementsCount: 12, profileImage: { src: 'https://placehold.co/400x400.png', aiHint: 'woman portrait' }, portfolio: [{src: 'https://placehold.co/400x400.png', aiHint: 'nail art'}] },
  { name: 'طراحی مو لاله', service: 'خدمات مو', location: 'ارومیه', phone: '09000000002', bio: 'کارشناس بالیاژ و مدل‌های موی مدرن. با استفاده از بهترین مواد و تکنیک‌های روز دنیا، رنگ و مدل موی دلخواه شما را به ارمغان می‌آوریم.', categorySlug: 'beauty', serviceSlug: 'haircut-coloring', rating: 4.9, reviewsCount: 62, agreementsCount: 25, profileImage: { src: 'https://placehold.co/400x400.png', aiHint: 'woman hair' }, portfolio: [] },
